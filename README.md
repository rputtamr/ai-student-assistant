...
Students waste time searching across multiple platforms for information about courses, study strategies, and campus life. This assistant centralizes that help into one conversational interface.
...
| Feature | Description |
|---|---|
| 💬 Chat UI | ChatGPT-style conversational interface |
| 📊 Live Analytics | Tracks which topics students ask about most |
...
- **Rule-based AI engine** — topic detection and response logic
- **Session State Management** — chat memory across interactions
...
This project was built with a full product mindset:

- **User Stories** — designed around real student pain points
...
**Reshikesh Reddy Puttamreddy**  
[GitHub](https://github.com/rputtamr)